...
<html>
  <body style='font-family: Arial, sans-serif; line-height:1.8;'>
    ...
    <p>نرحب بك في فريق <b>مركز اللغة المثالية للتدريب</b>! 🎉<br/>
       نحن متحمسون لانضمامك إلينا ونتطلع إلى العمل معك.</p>

    <p>
       ستكون جزءًا من بيئة تعليمية <b>مبدعة وداعمة</b>، حيث يمكنك مشاركة خبراتك ومهاراتك مع طلابنا.
    </p>

    <p>
       إذا كان لديك أي استفسار أو تحتاج إلى أي مساعدة، فلا تتردد في التواصل معنا.
    </p>

    <p>مرحبًا بك مرة أخرى في فريقنا! 🌟</p>

    <p>
      <b>بيانات الدخول الخاصة بك:</b><br/>
      👤 <b>اسم المستخدم:</b> {teacher.User.Email}<br/>
      🔑 <b>كلمة السر:</b> {teacherDto.Password}
    </p>
